  ...
  it.skipIf(process.platform === 'win32')(
    ...
    async () => {
      ...
      try {
        ...
        // Why: afterPack stamps the effective build version into the compiled
        // tree's package.json, which is the only version source `orca --version`
        // has under ELECTRON_RUN_AS_NODE.
        await writeFile(
