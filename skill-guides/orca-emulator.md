...
| Accessibility tree         | `ORCA emulator ax [--device <id>]`          | Raw serve-sim AX node tree (labels, roles, nested children; frames normalized 0..1, feed straight into tap/gesture). Needs an active session. |
