...
- **WeChat:** If group 6 is full, you can join group 7.

  <img src="docs/assets/wechat-qr-group6.jpg" alt="WeChat group 6 QR code for the Orca community" width="160" style="margin-right: 16px;" />
