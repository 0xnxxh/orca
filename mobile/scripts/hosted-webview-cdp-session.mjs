...
const CDP_TARGET_LIMIT = 16
const CDP_MESSAGE_MAX_BYTES = 2 * 1024 * 1024
const HOSTED_DOCUMENT_TEXT_LIMIT = 8 * 1024
...
async function readCdpTargets(discoveryUrl, fetchImpl) {
  ...
  return parsed.filter(isSafeCdpTarget)
}
...
async function probeHostedWebView(target, WebSocketCtor) {
  try {
