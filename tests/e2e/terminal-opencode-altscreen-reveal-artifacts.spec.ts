 ...
 *
 * ⚠ KNOWN LIMITATION — these tests do NOT detect a stale/garbled CANVAS.
 *
 * The field defect is "xterm's buffer is correct but the compositor keeps
 * showing pre-hide pixels". Two oracles were built for it and both were proven
