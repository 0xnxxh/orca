...
const EMPTY_LAUNCHABLE_AGENTS: Record<string, DashboardSpawnAgentArgs['agent'][]> = {}
const ignoreSpawnAgent = (): void => undefined
...
export function AgentMap({
  ...
  pinnedPaneKeys,
  reviewedPaneKeys,
  launchableAgentsByWorktreeId = EMPTY_LAUNCHABLE_AGENTS,
  onMarkReviewed,
  onOpenTerminal,
  onSpawnAgent = ignoreSpawnAgent
