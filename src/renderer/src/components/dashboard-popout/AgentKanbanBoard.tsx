...
import { ChartNoAxesGantt, Columns3, XIcon } from 'lucide-react'
import {
...
export type AgentDashboardView = 'board' | 'lanes'
        ...
        <div className="flex shrink-0 items-center gap-2 border-b border-border px-4 py-2.5">
          ...
          >
            ...
            <Button
              ...
              className={cn('h-6 gap-1 px-2', view === 'lanes' && 'bg-accent')}
              onClick={() => setView('lanes')}
            >
              <ChartNoAxesGantt className="size-3" />
              {translate('dashboardPopout.view.lanes', 'Activity Lanes')}
            </Button>
          </div>
        ...
        {view !== 'board' ? (
          ...
          >
            <ActivityLanes
              ...
              className={
                dialogCard
                  ? 'w-[clamp(22rem,48vw,46rem)] flex-none transition-[width] duration-200 motion-reduce:transition-none'
                  : undefined
              }
