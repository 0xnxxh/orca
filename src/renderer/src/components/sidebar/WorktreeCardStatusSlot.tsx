...
// Why: passive git identity may only fill the lane when the workspace has no
// activity signal at all; active/done keep their dot so status colors stay visible.
