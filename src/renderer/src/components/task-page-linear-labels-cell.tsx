...
export function LinearLabelsCell({
  ...
  const teamLabels = useTeamLabels(issue.team.id, providerSettings, issue.workspaceId)
      ...
      <PopoverTrigger asChild>
        ...
        >
          {issue.labels.length > 0 ? (
            ...
            <span className="inline-flex items-center gap-1 px-1 py-0.5 text-[11px] text-muted-foreground/70">
