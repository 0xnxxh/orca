...
import {
  ...
  areWorktreesEqual
} from '../catalog/worktree-catalog-visibility'
import {
...
} from '../refresh/detected-worktree-refresh'
import { isDetectedWorktreeListResult } from '../refresh/detected-worktree-provider-request'
import { staleDetectedWorktreeProviderResult } from '../refresh/detected-worktree-refresh-admission'
...
import type {
  ...
  WorktreeHostMatchOptions
} from '../slice/worktree-slice-types'
