/**
 * Generated shell-ready wrapper script bodies (bash rcfile, zsh .zshrc).
 *
 * Why: pure string builders — no filesystem access, no module state — so both the on-disk
 * wrapper writer and tests can render the exact script text a wrapped shell will source.
 */
