...
import { fingerprintAuthenticatedPairingDevice } from './rpc/orchestration-mutation-executor'
  ...
  private async handleWebSocketMessage(
    ...
    try {
      await this.dispatcher.dispatchStreaming(request, replyForRequest, {
        authenticatedCallerFingerprint: fingerprintAuthenticatedPairingDevice(device.deviceId),
        connectionId,
        clientId: token,
        pairedDeviceId: device.deviceId,
