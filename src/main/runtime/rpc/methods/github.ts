...
import { GITHUB_PR_REVIEW_METHODS } from './github-pull-request-review-methods'
import { GITHUB_PR_UPDATE_METHODS } from './github-pull-request-update-methods'
...
export const GITHUB_METHODS: RpcMethod[] = [
  ...
  ...GITHUB_PR_REVIEW_METHODS,
  ...GITHUB_PR_UPDATE_METHODS,
