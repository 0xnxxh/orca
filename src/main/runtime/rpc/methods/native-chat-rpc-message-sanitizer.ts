...
// Why: tool previews need a tight wire cap, while prose retains a generous
// safety ceiling so long assistant answers remain readable on mobile.
...
function sanitizeToolInput(
  ...
  for (const key in value) {
    ...
    // Why: suffix colliding bounded prefixes so sibling fields are not lost.
...
export function sanitizeNativeChatRpcMessage(
