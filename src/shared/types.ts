...
import type { ProviderNativeSessionTitle } from './provider-native-session-title'
...
export type Tab = {
  ...
  /** Stable provider-owned conversation name, bound to its provider session identity. */
