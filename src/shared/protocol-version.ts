...
// Why: older hosts strip browser.tabCreate's operation ID, so clients may only retry unknown outcomes when advertised.
export const BROWSER_TAB_CREATE_IDEMPOTENCY_RUNTIME_CAPABILITY =
  'browser.tab-create-idempotency.v1' as const
