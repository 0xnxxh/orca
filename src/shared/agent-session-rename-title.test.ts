...
const readClaudeSessionRenamedTitle = (lines: Iterable<string>): string | null =>
  findClaudeSessionRenameRecord(lines)?.customTitle ?? null
...
describe('the rename a Claude transcript currently records', () => {
