...
// VT ambiguity). Such a keystroke is sent immediately and shares the bounded
// reply budget; byte order is preserved, but a pathological reply flood can shed it.
